...
ggsave(
  filename = 'figures/figure5/point_range_Nterm_alphafold_property.eps',
...
### figure 5B, ubiquitination sites occurrence
...
ggsave(
  filename = 'figures/figure5/plot_half_life_ubi_occurence.eps',
  device = cairo_ps,
...
### figure 5C, phosphorylation sites occurrence
# Spearman correlation test
cor.test(
...
ggsave(
  filename = 'figures/figure5/plot_half_life_phos_occurence.eps',
  device = cairo_ps,
...
### figure 5D, hydropathy, NCPR and kappa of Nterm 13 mer 
...
ggsave(
  filename = 'figures/figure5/boxplot_Nterm_13mer_sequence_features.eps',
