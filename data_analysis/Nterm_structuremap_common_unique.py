...
#     proteins = common_Nterm_protein_list,
...
# annotate N-terminal proteoform data
common_Nterm_alphafold_N_terminus = common_Nterm_alphafold_accessibility_smooth_pattern_extended.merge(
...
# BEND
enrichment_N_terminus_BEND = perform_enrichment_analysis(
